...
export default function AboutPark({ parkData, facilityData }) {
  ...
  return (
    <div className="container">
      <div className={styles['about-bg']}>
        <img src="/images/about/main-park.webp" alt="" className={styles['bg-park']} />

        <Link href={`/about/detail?id=${item1?.ID}`} >
          <a>
            <img src="/images/about/btn-pic-road-sign-01.png" alt={item1?.Name} className={styles['sign01']} />
          </a>
        </Link>

        <Link href={`/about/detail?id=${item2?.ID}`}>
          <a>
            <img src="/images/about/btn-pic-road-sign-02.png" alt={item2?.Name} className={styles['sign02']} />
          </a>
        </Link>

        <Link href={`/about/detail?id=${item3?.ID}`}>
          <a>
            <img src="/images/about/btn-pic-road-sign-03.png" alt={item3?.Name} className={styles['sign03']} />
          </a>
        </Link>

        <Link href={`/about/detail?id=${item4?.ID}`} >
          <a>
            <img src="/images/about/btn-pic-road-sign-04.png" alt={item4?.Name} className={styles['sign04']} />
          </a>
        </Link>
      ...
      <div className={styles['about-mobile']}>
        <div className={styles['mobile-wrapper']}>
          ...
          <div className="text-right">
            <Link
              href={`/about/detail?id=${parkData?.Data?.rows?.find((item) => item.Sequence === 1)?.ID
                }`}
            >
        ...
        <div className={styles['mobile-wrapper']}>
          ...
          <div className="text-right">
            <Link
              href={`/about/detail?id=${parkData?.Data?.rows?.find((item) => item.Sequence === 2)?.ID
                }`}
            >
              <button className={styles['btn-main']}>
                {
        ...
        <div className={styles['mobile-wrapper']}>
          ...
          <div className="text-right">
            <Link
              href={`/about/detail?id=${parkData?.Data?.rows?.find((item) => item.Sequence === 3)?.ID
                }`}
            >
              <button className={styles['btn-main']}>
                {
        ...
        <div className={styles['mobile-wrapper']}>
          ...
          <div className="text-right">
            <Link
              href={`/about/detail?id=${parkData?.Data?.rows?.find((item) => item.Sequence === 4)?.ID
                }`}>
              <button className={styles['btn-main']}>
                {
