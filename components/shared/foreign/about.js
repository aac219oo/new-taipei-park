    ...
    <div className="container">
      <div className={styles['about-bg']}>
        ...
        <Link href={`/about/detail?id=${parkData?.Data?.rows?.find((item) => item.Sequence === 1)?.ID}`} >
          <a>
            <img src="/images/about/btn-pic-road-sign-01.png" alt={parkData?.Data?.rows?.find((item) => item.Sequence === 1)?.Name} className={styles['sign01']} />
          </a>
        </Link>

        <Link href={`/about/detail?id=${parkData?.Data?.rows?.find((item) => item.Sequence === 2)?.ID}`}>
          <a>
            <img src="/images/about/btn-pic-road-sign-02.png" alt={parkData?.Data?.rows?.find((item) => item.Sequence === 2)?.Name} className={styles['sign02']} />
          </a>
        </Link>

        <Link href={`/about/detail?id=${parkData?.Data?.rows?.find((item) => item.Sequence === 3)?.ID}`}>
          <a>
            <img src="/images/about/btn-pic-road-sign-03.png" alt={parkData?.Data?.rows?.find((item) => item.Sequence === 3)?.Name} className={styles['sign03']} />
          </a>
        </Link>

        <Link href={`/about/detail?id=${parkData?.Data?.rows?.find((item) => item.Sequence === 4)?.ID}`} >
          <a>
            <img src="/images/about/btn-pic-road-sign-04.png" alt={parkData?.Data?.rows?.find((item) => item.Sequence === 4)?.Name} className={styles['sign04']} />
          </a>
        </Link>
